<template>
    <div class="loader-full-screen" :class="{
        ...
        <div class="loader-full-screen-content" v-show="didReachStep(Steps.SHOWING_LOGO)">
            <ImageView :src="'images/icons/resume.ico'" :alt="'Logo'" :ignore-on-image-count="true" ref="uiLogo"
            ...
            <div class="progress-display" :class="{
                ...
                <ProgressBar ref="progressBar" class="progress-bar-wrapper" :percentage="percentage" />
            </div>
        </div>
    </div>
</template>
